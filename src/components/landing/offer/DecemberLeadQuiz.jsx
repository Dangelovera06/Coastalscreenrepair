      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[calc(100%-2rem)] max-w-lg max-h-[90vh] bg-neutral-900 rounded-2xl z-[101] overflow-hidden flex flex-col"
          >
            {/* Close Button */}
            <button
              onClick={onClose}
