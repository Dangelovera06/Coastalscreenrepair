...
export default function PipelineX() {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden relative">
      ...
      {/* Hard Truth / Benefits Section */}
      <section className="py-16 md:py-24 px-6 relative z-10 bg-black">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl sm:text-2xl font-bold text-red-500 mb-12 max-w-3xl mx-auto">
              PipelineX builds you a complete lead-generation system that actually fills your calendar.
            </p>
            ...
            <div className="space-y-8 mb-12">
              {[
                ...
                },
                {
                  ...
                  description: "We shoot, edit, and script cinematic short-form videos every month that stop scrollers dead in their tracks and turn attention into appointments.",
                  icon: "/website icons/30.png"
                },
                {
                  title: "YOU DON'T NEED TO CHASE LEADS",
                  description: "Our automated follow-up system handles both inbound inquiries and outbound follow-ups—qualifying leads, answering questions, and booking appointments 24/7.",
                  icon: "/website icons/31.png"
                },
                {
                  title: "YOU DON'T NEED TO FIGURE IT OUT ALONE",
                  description: "Dedicated support with strategy calls and performance reports. We're in the trenches with you, optimizing every step of the way.",
                ...
                <motion.div
                  ...
                  transition={{ duration: 0.6, delay: i * 0.1, ease: [0.22, 1, 0.36, 1] }}
                  viewport={{ once: true }}
                  className="p-8 rounded-2xl text-left bg-white/[0.02] border border-white/10"
                >
                  <img 
                    src={benefit.icon} 
                    alt="" 
                  ...
                  />
                  <p className="text-lg sm:text-xl md:text-2xl font-bold text-red-500 mb-3">
                    {benefit.title}
                  </p>
            ...
            <motion.div
              ...
              transition={{ duration: 0.6, delay: 0.4, ease: [0.22, 1, 0.36, 1] }}
              viewport={{ once: true }}
              className="p-8 sm:p-10 rounded-2xl bg-gradient-to-br from-red-600/10 to-red-600/5 border border-red-500/30 mb-12"
            >
              <p className="text-lg sm:text-xl md:text-2xl text-white/90 leading-relaxed text-center">
                Most businesses stay stuck posting on Instagram, hoping for calls.{' '}
                <span className="text-red-500 font-bold">Our partners have a machine that books them while they sleep.</span>
              </p>
            </motion.div>
            ...
            >
              <button
                onClick={() => setIsFormOpen(true)}
                className="px-12 py-3 bg-white text-black font-semibold rounded-lg hover:bg-white/90 transition-all shadow-[0_0_30px_rgba(255,255,255,0.5)] hover:shadow-[0_0_50px_rgba(255,255,255,0.7)]"
              >
                Apply Now
              </button>
            </motion.div>
